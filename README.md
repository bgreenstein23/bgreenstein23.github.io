...
* Designed and built an **Arduino-powered** elevator automation system operating within Shabbat restrictions.
* Combines physical hardware prototyping with embedded C++ code.
